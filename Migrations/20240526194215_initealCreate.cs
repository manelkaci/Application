...
{
    /// <inheritdoc />
    public partial class initealCreate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    mot_passe = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    Revenu = table.Column<float>(type: "real", nullable: true),
                    ...
                    Registre = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ActivitePrincipal = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Document_number = table.Column<int>(type: "int", nullable: true),
                    chiffre_affaire = table.Column<int>(type: "int", nullable: true),
                    effectif = table.Column<int>(type: "int", nullable: true),
                    nature_juridque = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    dénomination_sociale = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_carteProduct", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_creditProduct", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_packProduct", x => x.Id);
                });
